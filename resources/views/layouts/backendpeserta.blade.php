                    ...
                    <div class="content-header bg-white-10">
                        ...
                        <a class="font-w600 text-white tracking-wide" href="/">
                            <span class="smini-visible">
                                C<span class="opacity-75">s</span>
                            </span>
                            <span class="smini-hidden">
                                Chemist<span class="opacity-75"> Fun Days</span>
                            </span>
                        </a>
                        <!-- END Logo -->
                ...
                <div class="content-header">
                    ...
                    <div>
                        ...
                        <button type="button" class="btn btn-dual" data-toggle="layout" data-action="header_search_on">
                            <i class="fa fa-fw fa-search"></i> <span class="ml-1 d-none d-sm-inline-block">Pencarian</span>
                        </button>
                    ...
                    <div>
                        ...
                        <div class="dropdown d-inline-block">
                            <button type="button" class="btn btn-dual" id="page-header-notifications-dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                {{-- untuk zaki nanti ketika notifikasi kosong angka pada pill berubah --}}
                                    ...
                                    <li>
                                        <a class="text-dark media py-2" href="javascript:void(0)">
                                            ...
                                            <div class="media-body font-size-sm pr-2">
                                                <div class="font-w600">Contoh notif berkas diverifikasi</div>
                                                <div class="text-muted font-italic">3 menit yang lalu</div>
                                            </div>
                                        </a>
                                    </li>
                                    <li>
                                        <a class="text-dark media py-2" href="javascript:void(0)">
                                            ...
                                            <div class="media-body font-size-sm pr-2">
                                                <div class="font-w600">Berkas ditolak pada saat ferivikasi</div>
                                                <div class="text-muted font-italic">30 menit yang lalu</div>
                                            </div>
                                        </a>
                                    </li>
                                    <li>
                                        <a class="text-dark media py-2" href="javascript:void(0)">
                                            ...
                                            <div class="media-body font-size-sm pr-2">
                                                <div class="font-w600">Pemberitahuan ujian</div>
                                                <div class="text-muted font-italic">1 jam yang lalu</div>
                                            </div>
                                        </a>
                                    </li>
                                </ul>
